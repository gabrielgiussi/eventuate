...
*/
class BasicEventLogMembershipSpecLeveldb extends BasicEventLogMembershipSpec(new BasicEventLogMembershipSpecConfig(providerConfig)) with MultiNodeSupportLeveldb
class BasicEventLogMembershipSpecLeveldbMultiJvmNode1 extends BasicEventLogMembershipSpecLeveldb
class BasicEventLogMembershipSpecLeveldbMultiJvmNode2 extends BasicEventLogMembershipSpecLeveldb
class BasicEventLogMembershipSpecLeveldbMultiJvmNode3 extends BasicEventLogMembershipSpecLeveldb
class BasicEventLogMembershipSpecLeveldbMultiJvmNode4 extends BasicEventLogMembershipSpecLeveldb