...
class FilteredReplicationSpecLeveldb extends FilteredReplicationSpec(new FilteredReplicationConfig(providerConfig)) with MultiNodeSupportLeveldb
...
class ReplicatedPersistOnEventSpecLeveldb extends ReplicatedPersistOnEventSpec(new ReplicatedPersistOnEventConfig(providerConfig)) with MultiNodeSupportLeveldb
class ReplicatedPersistOnEventSpecLeveldbMultiJvmNode1 extends ReplicatedPersistOnEventSpecLeveldb
class ReplicatedPersistOnEventSpecLeveldbMultiJvmNode2 extends ReplicatedPersistOnEventSpecLeveldb

class ReplicatedPersistOnEventSpec2Leveldb extends ReplicatedPersistOnEventSpec2(new ReplicatedPersistOnEvent2Config(providerConfig)) with MultiNodeSupportLeveldb
class ReplicatedPersistOnEventSpec2LeveldbMultiJvmNode1 extends ReplicatedPersistOnEventSpec2Leveldb
class ReplicatedPersistOnEventSpec2LeveldbMultiJvmNode2 extends ReplicatedPersistOnEventSpec2Leveldb